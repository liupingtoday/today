...
// */
//package cn.js.today.common.text;
//
...
//    LinkedList<DiffMatchPatch.Diff> diffs = diffList(new Diff(EQUAL, "\u0001\u0002\u0001"), new DiffMatchPatch.Diff(INSERT, "\u0002\u0001\u0002"));
//    ArrayList<String> tmpVector = new ArrayList<String>();
//    tmpVector.add("");
//    tmpVector.add("alpha\n");
//    tmpVector.add("beta\n");
...
//
//    diffs = diffList(new DiffMatchPatch.Diff(DELETE, "a"), new Diff(DELETE, "b"), new Diff(DELETE, "c"));
//    dmp.diff_cleanupMerge(diffs);
