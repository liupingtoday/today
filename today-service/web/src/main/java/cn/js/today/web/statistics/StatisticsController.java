...
//    }
    ...
    public String getClipCloudLatest7DaysUsage() {
        ...
        try {
            ...
            JSONObject httpResponseJsonObject = JSONUtil.parseObj(httpResponseStr);
            Boolean isSuccess = (Boolean) httpResponseJsonObject.get("success");
            String code = (String) httpResponseJsonObject.get("code");
            String message = (String) httpResponseJsonObject.get("message");
            if(isSuccess){
                accessToken = httpResponseStr.substring(httpResponseStr.indexOf("accessToken") + 14,httpResponseStr.indexOf("refreshToken")-3);
            }else {
                return "isSuccess is " + isSuccess + ", code:" + code + ",message:" + message;
            }
